...
const Modal = () => {
  return (
    <div className="absolute w-screen h-screen bg-yellow-800/60 top-[10vh] -left-16">
      <div className=" w-2/3 bg-black h-full flex flex-col items-start justify-start pl-10  pt-20  text-2xl text-white shadow-lg  leading-10 ">
