...
const Footerbanner = () => {
  ...
  return (
    <section className=" min-h-[100px ] w-[80vw] py-4 sm:py-6  px-8 md:py-10 absolute rounded-lg shadow-2xl -top-48 md:-top-32 left-20 bg-yellow-400 mx-auto z-50 overflow-hidden">
      <div className="relative w-full h-full z-50">
        ...
        <article className=" z-50 flex flex-col md:flex-row items-center justify-center md:justify-between  overflow-hidden   ">
          ...
          <button
            className=" z-50bg-transparent bg-yellow-600 text-sm sm:text-lg md:text-xl  px-3 md:px-6 py-1 md:mt-9 mt-3 hover:font-bold hover:scale-105 transition-all delay-75 ease-in active:bg-yellow-800 capitalize md:font-semibold  text-white   "
