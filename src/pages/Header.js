...
const Header = () => {
	...
	return (
		<header className='h-screen w-screen  relative pt-[20vh] bg-graphics bg-cover object-cover before:absolute before:bg-black/50 before:inset-0 overflow-x-hidden       '>
			<div className='absolute top-[14vh] sm:top-24 w-[85vw] sm:w-1/2 right-7 left-7  px-4  md:px-14 py-6 shadow-2xl  text-gray-100 my-auto bg-indigo-800/20       '>
				...
				<button
					className=' bg-yellow-600/40 text-lg md:text-xl  px-3 md:px-6 py-1 md:mt-9 mt-3 hover:text-gray-300 hover:bg-opacity-90 transition-all delay-75 ease-in active:bg-yellow-800 capitalize font-semibold '
