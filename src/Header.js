...
const Header = () => {
  return (
    <header className="h-screen w-screen  relative pt-[20vh] bg-graphics bg-cover object-cover before:absolute before:bg-black/50 before:inset-0       ">
      <div className="absolute top-[10vh] sm:top-24 w-full sm:w-1/2 px-4  md:px-14 py-6 shadow-2xl  text-gray-100 my-auto bg-indigo-800/20       ">
        ...
        <button className="bg-transparent bg-yellow-600 text-lg md:text-xl  px-3 md:px-6 py-1 md:mt-9 mt-3 hover:font-bold hover:scale-105 transition-all delay-75 ease-in active:bg-yellow-800 capitalize font-semibold ">
          get in touch
        </button>
      </div>
    </header>
